      ...
      <Carousel>
        <Carousel.Item>
          ...
          <Carousel.Caption className="mb-[10rem] w-[36rem] text-start text-black">
            ...
            <ParagrafoPasseio>
              Venha conhecer os lencois, com passeios increveis e paisagens
              maravilhosas
            </ParagrafoPasseio>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption className="mb-[10rem] w-[36rem] text-start text-black">
            ...
            <ParagrafoPasseio>
              Incriveis aventuras em passeios de Hilux pelas Dunas
            </ParagrafoPasseio>
            <BookNow>Book Now</BookNow>
          </Carousel.Caption>
        </Carousel.Item>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption className="mb-[10rem] w-[36rem] text-start text-black">
            ...
            <ParagrafoPasseio>
              Passeios inesqueciveis sobrevoando as dunas
            </ParagrafoPasseio>
            <BookNow>Book Now</BookNow>
          </Carousel.Caption>
        </Carousel.Item>
